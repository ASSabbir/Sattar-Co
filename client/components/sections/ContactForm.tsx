  ...
  if (submitted) {
    return (
      <motion.div
        ...
        className="border border-zinc-900/15 rounded-sm p-10 text-center"
      >
        <p className="font-display text-2xl text-zinc-950 mb-3">Thank you.</p>
        <p className="text-zinc-950/60">
